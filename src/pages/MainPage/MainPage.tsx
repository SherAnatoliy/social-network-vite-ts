...
const UserFriedndData =[
  {
    ...
    linkImg:"./img/users/darya-gertner.jpeg",
    mainText:"Дарья Гертнер",
    secondaryText:"Онлайн",
    online:"_online",
  },  {
    linkImg:"./img/users/denis-frolov.jpeg",
    mainText:"Look",
    secondaryText:"Онлайн",
    online:"_online",
  },
...
export const MainPage = () => {
  // const newLocal = userElemData.map((elem) => (elem))}
  return (
    <>
      ...
      <aside className="LeftSide">
        ...
        <div className="List">
          <div className="List__title">
            <Heading headingType={"h2"} headingText="Подписки" />
